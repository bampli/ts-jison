 ...
 */
export const tsCalculator = (function(){
...
exports.parser = tsCalculator;
exports.Parser = tsCalculator.Parser;
exports.parse = function () { return tsCalculator.parse.apply(tsCalculator, arguments[0]); };
// @ts-ignore;
