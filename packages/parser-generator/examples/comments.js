...
yy: {},
symbols_: {"error":2,"corruption":3,"dark_arts":4,"EOF":5,"pyrotechnics":6,"TEXT":7,"COMMENT":8,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",7:"TEXT",8:"COMMENT"},
productions_: [0,[3,2],[4,1],[4,2],[6,1],[6,1]],
...
table: [{3:1,4:2,6:3,7:$V0,8:$V1},{1:[3]},{5:[1,6],6:7,7:$V0,8:$V1},o($V2,[2,2]),o($V2,[2,4]),o($V2,[2,5]),{1:[2,1]},o($V2,[2,3])],
...
case 0:
                                //console.log("comment : " + showInvisibles(yy_.yytext));
...
break;
case 3:
                                //console.log("text : " + showInvisibles(yy_.yytext));
                                return 7;
...
rules: [/^(?:<--)/,/^(?:-->)/,/^(?:((.|\s)))/,/^(?:((.|\s)))/,/^(?:$)/],
conditions: {"Comments":{"rules":[1,2,3,4],"inclusive":true},"INITIAL":{"rules":[0,3,4],"inclusive":true}}
});
/**
 * ## Lexer: User Code
 */
