...
exports.tsCalculator = (function () {
    ...
    var ParserClass = /** @class */ (function () {
        ...
        ParserClass.prototype.trace = function (str) { };
        ParserClass.prototype.performAction = function (yytext, yyleng, yylineno, yy, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */) {
            /* this == yyval */
            var $0 = $$.length - 1;
            switch (yystate) {
                case 1:
        ...
        ParserClass.prototype.parseError = function (str, hash) {
            if (hash.recoverable) {
                this.trace(str);
            }
            else {
        ...
        ParserClass.prototype.parse = function (input) {
    ...
    var lexer = ( /* generated by ts-jison-lex 0.0.1 */function () {
        var LexerClass = /** @class */ (function () {
            function LexerClass() {
                this.yy = {};
                this.EOF = 1;
                this.options = {};
            ...
            LexerClass.prototype.parseError = function (str, hash) {
                if (this.yy.parser) {
            ...
            LexerClass.prototype.setInput = function (input, yy) {
                this.yy = yy || this.yy || {};
                this._input = input;
            ...
            LexerClass.prototype.input = function () {
            ...
            LexerClass.prototype.unput = function (ch) {
                var len = ch.length;
                var lines = ch.split(/(?:\r\n?|\n)/g);
            ...
            LexerClass.prototype.more = function () {
                this._more = true;
                return this;
            };
            // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
            LexerClass.prototype.reject = function () {
            ...
            LexerClass.prototype.less = function (n) {
                this.unput(this.match.slice(n));
            };
            // displays already matched input, i.e. for error messages
            LexerClass.prototype.pastInput = function () {
                var past = this.matched.substr(0, this.matched.length - this.match.length);
                return (past.length > 20 ? '...' : '') + past.substr(-20).replace(/\n/g, "");
            };
            // displays upcoming input, i.e. for error messages
            LexerClass.prototype.upcomingInput = function () {
                var next = this.match;
                if (next.length < 20) {
            ...
            LexerClass.prototype.showPosition = function () {
                var pre = this.pastInput();
                var c = new Array(pre.length + 1).join("-");
                return pre + this.upcomingInput() + "\n" + c + "^";
            };
            // test the lexed token: return FALSE when not a match, otherwise return token
            LexerClass.prototype.test_match = function (match, indexed_rule) {
            ...
            LexerClass.prototype.next = function () {
                if (this.done) {
                    return this.EOF;
                }
                if (!this._input) {
            ...
            LexerClass.prototype.lex = function () {
                var r = this.next();
                if (r) {
                    return r;
                }
            ...
            LexerClass.prototype.begin = function (condition) {
                this.conditionStack.push(condition);
            };
            // pop the previously active lexer condition state off the condition stack
            LexerClass.prototype.popState = function () {
            ...
            LexerClass.prototype._currentRules = function () {
            ...
            LexerClass.prototype.topState = function (n) {
            ...
            LexerClass.prototype.pushState = function (condition) {
                this.begin(condition);
            };
            // return the number of states currently on the stack
            LexerClass.prototype.stateStackSize = function () {
                return this.conditionStack.length;
            };
            LexerClass.prototype.performAction = function (yy, yy_, $avoiding_name_collisions, YY_START) {
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
    exports.parser = exports.tsCalculator;
    exports.Parser = exports.tsCalculator.Parser;
    exports.parse = function () { return exports.tsCalculator.parse.apply(exports.tsCalculator, arguments[0]); };
    // @ts-ignore;
