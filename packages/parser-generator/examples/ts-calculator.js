...
exports.Lexer = exports.Parser = void 0;
...
var Parser = /** @class */ (function (_super) {
    ...
    function Parser(yy, lexer) {
        if (yy === void 0) { yy = {}; }
        if (lexer === void 0) { lexer = new Lexer(yy); }
    ...
    Parser.prototype.performAction = function (yytext, yyleng, yylineno, yy, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */) {
        /* this == yyval */
        var $0 = $$.length - 1;
        switch (yystate) {
            case 1:
...
var Lexer = /** @class */ (function (_super) {
    ...
    Lexer.prototype.performAction = function (yy, yy_, $avoiding_name_collisions, YY_START) {
        var YYSTATE = YY_START;
        switch ($avoiding_name_collisions) {
            case 0:
                if (yy.trace)
                    yy.trace("skipping whitespace " + hexlify(yy_.yytext)); // doesn't return
                break;
            case 1:
                return 15;
                break;
