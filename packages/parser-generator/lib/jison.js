...
generator.constructor = function Jison_Generator (grammar, opt) {
    ...
    if (grammar.lex) {
        ...
        if (opt.moduleName) {
            if ('options' in dict) {
                dict.options.moduleName = opt.moduleName;
            } else {
                dict.options = { moduleName: opt.moduleName };
            }
        }
...
lrGeneratorMixin.generateAMDModule = function generateAMDModule(opt){
    ...
    var out = '\n\ndefine(function(require){\n'
        ...
        + (this.lexer && this.lexer.generateModule ?
          '\nvar lexer = ' + this.lexer.generateModule(opt) +
          '\nparser.lexer = lexer;' : '')
        + '\nreturn parser;'
        + '\n});'
    return out;
...
lrGeneratorMixin.generateModuleCore = function generateModuleCore (opt) {
    ...
    out += this.generateModuleCode(opt) + "\n";
...
lrGeneratorMixin.generateModuleExpr = function generateModuleExpr (opt) {
    var out = '';
    var moduleCode = this.generateModuleCode(opt);
...
lrGeneratorMixin.generateModuleCode = function generateModuleCode (opt) {
