...
var Lexer      = require('@ts-jison/lexer-generator');
...
lrGeneratorMixin.generateAMDModule = function generateAMDModule(opt){
    opt = typal.mix.call({}, this.options, opt);
    var moduleCode = this.generateModuleCode();
    var out = '\n\ndefine(function(require){\n'
        + moduleCode
        + '\nvar parser = '
        + "\n"+this.moduleInclude
        + (this.lexer && this.lexer.generateModule ?
          '\nvar lexer = ' + this.lexer.generateModule() +
          '\nparser.lexer = lexer;' : '')
        + '\nreturn parser;'
        + '\n});'
    return out;
...
lrGeneratorMixin.generateCommonJSModule = function generateCommonJSModule (opt) {
    ...
    var out = this.generateModule(opt)
        ...
        + "\nexports.parse = function () { return "+moduleName+".parse.apply("+moduleName+", arguments[0]); };"
        + "\n// @ts-ignore;"
...
lrGeneratorMixin.generateModuleCore = function generateModuleCore (opt) {
    opt = typal.mix.call({}, this.options, opt);
    var moduleName = opt.moduleName || "parser";
    var out = "/* parser generated by jison " + version + " */\n"
        + "/**\n"
...
lrGeneratorMixin.generateModuleExpr = function generateModuleExpr () {
    ...
    if (this.lexer && this.lexer.generateModule) {
        out += "var lexer = " + this.lexer.generateModule();
        out += "\nparser.lexer = lexer;";
    }
    out += "\nreturn parser;\n})();";
...
lrGeneratorMixin.generateModuleCode = function generateModuleCode () {
    ...
    var moduleCode = tableCode.commonCode;
...
lrGeneratorMixin.createParser = function createParser () {
    ...
    p.generateModuleCore = bind('generateModuleCore');
